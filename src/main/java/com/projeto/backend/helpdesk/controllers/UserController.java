package com.projeto.backend.helpdesk.controllers;
...
import com.projeto.backend.helpdesk.response.Response;
...
@CrossOrigin(origins = "*") // libera todas as portas para o servidor
public class UserController {
    ...
    /* metodo vreate para salvar um novo usuario usando o objeto response */
    @PostMapping()
    @PreAuthorize("hasAnyRole(ADMIN)") // autorizcao de acordo com o perfil para usar o metodo
